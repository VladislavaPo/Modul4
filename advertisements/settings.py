...
SECRET_KEY = 'django-insecure-9y6)z7r&=9(91v4$%z-yxg4@a%bg*%i#%*y===mw^^83g!!q&j'
...
MEDIA_ROOT = Path.joinpath(BASE_DIR, 'media/')  # отвечает за путь где хранятся все медиа файлы
